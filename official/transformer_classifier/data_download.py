...
# that creates a vocabulary set that is closest in size to _TARGET_VOCAB_SIZE.
_TRAIN_DATA_SOURCES = [
    {
...
# Use pre-defined minimum count to create subtoken vocabulary.
...
# Strings to include in the created files.
_PREFIX = "wmt32k"
_TRAIN_TAG = "train"
...
def main(unused_argv):
    """Obtain training and evaluation data for the TransformerClassifier model."""
