...
```
cd /path/to/models/official/transformer_decoder
...
# Export variables
PARAM_SET=big
DATA_DIR=$HOME/transformer_decoder/data
MODEL_DIR=$HOME/transformer_decoder/model_$PARAM_SET
...
```
EXPORT_DIR=$HOME/transformer_decoder/saved_model
python transformer_main.py --data_dir=$DATA_DIR --model_dir=$MODEL_DIR \
...
1. #### Encode the inputs to integer arrays.
   ...
   ```
   from official.transformer_decoder.utils.tokenizer import Subtokenizer
