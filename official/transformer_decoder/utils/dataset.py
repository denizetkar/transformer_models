...
# ==============================================================================
"""Input pipeline for the transformer_decoder model to read, filter, and batch examples.
...
def _batch_examples(dataset, batch_size, max_length):
    ...
    def batching_fn(bucket_id, grouped_dataset):
        ...
        return grouped_dataset.padded_batch(bucket_batch_size, tf.TensorShape([None]))
...
def _read_and_batch_from_files(
    ...
    if static_batch:
        dataset = dataset.apply(tf.contrib.data.padded_batch_and_drop_remainder(
            batch_size // max_length, tf.TensorShape([max_length])))
    else:
